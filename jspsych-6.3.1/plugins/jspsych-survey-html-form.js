...
jsPsych.plugins['survey-html-form'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add submit button //// this has been modified to hide the button by adding - style="visibility:hidden;" 
    // https://github.com/jspsych/jsPsych/discussions/1342?sort=top
    html += '<input type="submit" id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form" value="'+trial.button_label+'" style="visibility:hidden;"></input>';
    ...
    /////// this has been added to disable the enter key from advancing a trail
...
// this block of code is new to modify the plugin to add the parameter - trial duration - to survey-html-form
// https://github.com/jspsych/jsPsych/discussions/2107
